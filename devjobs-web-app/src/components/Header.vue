<template>
  <div class="header">
    <div class="header-content">
      <h1>devjobs</h1>
      <div class="header-content-switch">
        <svg class="header-sun" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
          <path
        ...
        <switchBtn v-model="switchMode" />

        <svg class="header-moon" width="20" height="20" xmlns="http://www.w3.org/2000/svg">
          <path
